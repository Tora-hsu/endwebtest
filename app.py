...
def result_json():
    ...
    status_val = -1
    dic={-1:"判別異常",0:"準時抵達",1:"delay 30 分鐘",2:"delay 30 ~ 60 分鐘",3:"delay 60 ~ 90 分鐘",
    ...
    endcontinent=endcontinent,endairport=endairport,date=date,AWND_x=AWND_x,PRCP_x=PRCP_x,TMAX_x=TMAX_x,
